...
public class Server {
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        LabCollection kkk = pullCollection(connection1);
            ...
            public void run() {
                ...
                try {
                    ...
                    while (receiveTimeout.getState() != Thread.State.WAITING) {
                        ...
                        System.out.println();
                        System.out.println();
                        returnCollection = pullCollection(connection);
    ...
    public static LabCollection pullCollection(Connection connection){
        LabCollection returnCollection=new LabCollection();
        try {
            PreparedStatement st1 = connection.prepareStatement("select * from Humans;");
            ResultSet rs = st1.executeQuery();
            ...
            while (cs.next()) {
                ...
                random.setLocation(cs.getString("location"));
                random.setAge(cs.getInt("age"));
                random.setLastChangeTime(ZonedDateTime.ofInstant(cs.getTimestamp("time").toInstant(), ZoneId.of("UTC")));
                System.out.print(random.getLastChangeTime().toString());
                col.add(random);
            }
